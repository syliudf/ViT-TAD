...
def split_videos(video_dir,video_info, clip_length, stride, binary_class=False):
    training_list = []
    min_anno_dict = {}
    for video_name in list(video_info.keys())[:]:
        ...
        temp_video_name = osp.join(video_dir,temp_video_name)
...
class ANET_Dataset(Dataset):
    def __init__(
        ...
        self.training_list, self.th = split_videos(video_dir,video_info, clip_length, stride, binary_class)
